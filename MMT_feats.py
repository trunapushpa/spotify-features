...
y_spec_band=librosa.feature.spectral_bandwidth(y=y, sr=22050, S=None, n_fft=2048, window='hann', center=True, pad_mode='reflect',p=2)
y_spec_contrast=librosa.feature.spectral_contrast(y=y, sr=22050, window='hann', center=True, pad_mode='reflect', fmin=200.0, n_bands=6, quantile=0.02, linear=False)
